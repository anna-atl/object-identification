                                            ...
                                            if len(matched_pairs) != 0:
                                                ...
                                                for comparison_method in attribute_pars.comparison_methods:
                                                    ...
                                                    try:
                                                        ...
                                                        print('runtimerror')
                                                        experiment_results = exporting_experiment_results.main(0,
                                                                                                               mats.scenario_name,
                                                                                                               experiment_number,
                                                                                                               mats.dataset_size,
                                                                                                               0,
                                                ...
                                                df_experiment_results = df_experiment_results.append(experiment_results, ignore_index=True)
        df_experiment_results = df_experiment_results.sort_values(by=['attribute_threshold','bands_number', 'signature_size','shingle_weight','shingle_type', 'shingle_size'], ascending=True)
